...
Before Michigan, I was a Research Assistant at the [CLeAR Lab](https://clear-nus.github.io/), National University of Singapore, with [Prof. Harold Soh](https://haroldsoh.com/), working on diffusion-based planning and social navigation for legged robots. During my undergrad at [BITS Pilani, K.K. Birla Goa Campus](https://www.bits-pilani.ac.in/goa/), I spent a year at CMU's [Biorobotics Lab](https://biorobotics.ri.cmu.edu/index.php) with [Prof. Howie Choset](https://www.ri.cmu.edu/ri-faculty/howie-choset/) and [Prof. Robin Murphy](https://engineering.tamu.edu/cse/profiles/rmurphy.html), working on legged-wheeled robot control and 3D perception for search and rescue.
